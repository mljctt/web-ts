module.exports = `// Type definitions for koa-router v7.x
...
declare module Router {
    ...
    export interface IRouterContext extends Koa.Context {
         ...
         */
        params: any;
        getUserInfo: () => Promise<UserCacheInfo>;
    }
// ---------------- 用户缓存接口 Start -----------------
    interface UserCacheInfo {
        CardCode: string;
        CardName: string;
        is_admin: number;
        roles: string[];
    ...
    interface SubMenu2 {
        url: string;
        tabList?: TabList2[];
        api_list: (Apilist2 | Apilist2 | Apilist | Apilist | null)[];
        name: string;
        title: string;
        checked: boolean;
        tabs?: TabList2[];
